  ...
  },
  {
   ...
   "source": [
    ...
    "        print(f\"\\n⚠️ WARNING: {len(overfitting_models)} models show overfitting: {', '.join(overfitting_models)}\")\n",
 ...
 "nbformat_minor": 4
  ...
  },
  {
   ...
   "source": [
    ...
    "    print(\"  📊 Creating interactive TF activity plot...\")\n",
    "    \n",
  ...
  },
  {
   ...
   "source": [
    ...
    "    print(\"  📊 Creating interactive summary visualization...\")\n",
    "    \n",
  ...
  },
  {
   ...
   "source": [
    ...
    "        print(\"  ⚠️ Limited TFs found with patterns, using top variable RNA features\")\n",
    ...
    "    \n",
    "    print(f\"  📊 Found {len(potential_tfs)} potential TF features\")\n",
    "    \n",
